...
{
    class DriversIndexPrinterFriendlyReport
    {
        public static void Generate(Report report, string fileSaveDirectory, Application app)
        {
            ...
            {
                string message = AppCommon.AppendInnerExceptionMessages("DriversIndexViewReport.Generate: " + e.Message, e);
        ...
        private static void AddDocumentBody(Document document)
        {
            ...
            List<Driver> driversWebData = new List<Driver>();
            driversWebData = Web_Data.DriversWebData.GetDrivers();
            ...
            // add table data rows
            foreach (Driver driver in driversWebData)
            {
                table.Rows.Add();
                // format data row
                ...
                table.Rows[table.Rows.Count].Cells[1].Range.Text = driver.Firstname.ToString();
                table.Rows[table.Rows.Count].Cells[2].Range.Text = driver.Lastname.ToString();
                table.Rows[table.Rows.Count].Cells[3].Range.Text = driver.Email.ToString();
                table.Rows[table.Rows.Count].Cells[4].Range.Text = driver.HomePhone.ToString();
                table.Rows[table.Rows.Count].Cells[5].Range.Text = driver.CellPhone.ToString();
                table.Rows[table.Rows.Count].Cells[6].Range.Text = driver.WorkPhone.ToString();
                table.Rows[table.Rows.Count].Cells[7].Range.Text = driver.DateOfBirth.ToString();
