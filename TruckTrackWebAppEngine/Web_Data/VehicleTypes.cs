...
namespace TruckTrackWebAppEngine.Web_Data
{
    class VehicleTypesWebData
    {
        ...
        public static List<VehicleType> GetVehicleTypes()
        {
            ...
            string webApiPath = "api/VehicleTypesData";
            string results = "";
            try
            {
                ...
                return JsonConvert.DeserializeObject<List<VehicleType>>(results);
            }
            catch (Exception e)
            {
                string message = AppCommon.AppendInnerExceptionMessages("GetVehicleTypes: " + e.Message, e);
